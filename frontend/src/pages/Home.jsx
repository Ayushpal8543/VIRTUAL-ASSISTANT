...
//      const { type, userInput, response, query, location, language, text, appName, lang } = dat
//      setAiText(response
...
//        if (isSpeakingRef.current) retur
//        setIsListening(true)
...
//    }, [userData, serverUrl]
//    return (
//      <div className="w-full min-h-screen bg-gradient-to-t from-black to-[#02023d] flex flex-col items-center justify-center px-4 py-6 gap-[20px]" style={{ position: 'relative', overflow: 'hidden' }}
//        <ParticleBackground /
//        <style>{`
//          @keyframes mic-pulse {
