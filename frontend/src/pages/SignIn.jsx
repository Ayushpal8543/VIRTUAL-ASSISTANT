...
function SignIn() {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000069] backdrop-blur shadow-lg shadow-blue-500 flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
        ...
        <p
          className='text-blue-400 text-[15px] cursor-pointer self-end pr-[10px] hover:underline'
